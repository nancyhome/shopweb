...
<title>ShoppingWebsiteHome</title>
...
<body>
	<div class="container-fluid">
		...
		<div class="container-fluid">
			<div class="col-md-12">
				<h2>
					Hot Product&nbsp;&nbsp;<img src="img/title2.jpg" />
				</h2>
			</div>
			<div class="col-md-2"
			...
			<div class="col-md-10">
				...
				<c:forEach items="${hotProductList }" var="hotPro">
					<div class="col-md-2"
						...
						<p>
							<a href="product_info.html" style='color: #666'>
								${hotPro.pname }</a>
						</p>
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;
								${hotPro.shop_price }</font>
						</p>
					</div>
				</c:forEach>
		...
		<div class="container-fluid">
			<div class="col-md-12">
				<h2>
					New Product&nbsp;&nbsp;<img src="img/title2.jpg" />
				</h2>
			</div>
			<div class="col-md-2"
				style="border: 1px solid #E7E7E7; border-right: 0; padding: 0;">
