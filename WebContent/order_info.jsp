	...
	<div class="container">
		<div class="row">
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						<tr class="warning">
							<th colspan="5">Order Number:9005</th>
						</tr>
						<tr class="warning">
							<th>Image</th>
							<th>Product</th>
		...
		<div>
			...
			<form id="orderForm" class="form-horizontal"
				...
				<div class="form-group">
					<label for="inputPassword3" class="col-sm-1 control-label">Name</label>
					<div class="col-sm-5">
				...
				<div class="form-group">
					<label for="confirmpwd" class="col-sm-1 control-label">Phone
						Number</label>
					<div class="col-sm-5">
