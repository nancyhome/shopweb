			...
			<div class="col-md-5">
				<div
					...
					<form class="form-horizontal" method="post" action="${pageContext.request.contextPath }/user?method=login">
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-sm-2 control-label">Verifyingcode</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" id="inputPassword3"
									placeholder="Verifyingcode">
							</div>
							<div class="col-sm-3">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label> <input type="checkbox"> Auto login
									</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label> <input
										type="checkbox"> Remember Password
									</label>
								</div>
							</div>
						</div>
