	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="./product?method=index">HomePage&nbsp;&nbsp;&gt;</a> <a href="javascript:">${cid }&nbsp;&nbsp;&gt;</a>
				<a>${product.pname }</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div
						...
						<div>
							<a
								href="${pageContext.request.contextPath}/product?method=productList&cid=${cid }&currentPage=${currentPage}">Return To ItemList</a>
						</div>
					</div>
				</div>
			</div>
