...
import com.tianyuHouWebMall.domain.Cart;
import com.tianyuHouWebMall.domain.CartItem;
import com.tianyuHouWebMall.domain.Category;
import com.tianyuHouWebMall.domain.Order;
import com.tianyuHouWebMall.domain.OrderItem;
...
import com.tianyuHouWebMall.service.ProductService;
import com.tianyuHouWebMall.utils.CommonUtils;
import com.tianyuHouWebMall.utils.JedisPoolUtils;
import com.tianyuHouWebMall.utils.PaymentUtil;
...
public class ProductServlet extends BaseServlet {
	...
	public void addProductToCart(HttpServletRequest request, HttpServletResponse response)
		...
		double newSubTotal = buyNum*pro.getShop_price();
		
		if(cartItems.containsKey(pid)) {
			CartItem cartItem = cartItems.get(pid);
			cartItem.setBuyNum(cartItem.getBuyNum()+buyNum);
			cartItem.setSubtotal(newSubTotal+cartItem.getSubtotal());
		}else {
